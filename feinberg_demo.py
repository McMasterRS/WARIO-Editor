...
# Node A
nodeA = nodz.createNode(name='Sound Files', preset='node_preset_1', position=None)

nodz.createAttribute(node=nodeA, name='Data', index=-1, preset='attr_preset_1',
                     plug=True, socket=False, dataType=int)



# Node B
nodeB = nodz.createNode(name='Measure', preset='node_preset_1')

nodz.createAttribute(node=nodeB, name='In - Passthrough', index=-1, preset='attr_preset_2',
                     plug=True, socket=True, dataType=int)

nodz.createAttribute(node=nodeB, name='Out', index=-1, preset='attr_preset_1',
                     plug=True, socket=False, dataType=int)
...
# Node C
nodeC = nodz.createNode(name='Manipulate', preset='node_preset_1')

nodz.createAttribute(node=nodeC, name='In', index=-1, preset='attr_preset_3',
                     plug=False, socket=True, dataType=int)

nodz.createAttribute(node=nodeC, name='Out', index=-1, preset='attr_preset_1',
                     plug=True, socket=False, dataType=int)


nodeD = nodz.createNode(name='Plot Manipulate', preset='node_preset_1')

nodz.createAttribute(node=nodeD, name='In', index=-1, preset='attr_preset_3',
                     plug=False, socket=True, dataType=int)

nodeE = nodz.createNode(name='Plot Original', preset='node_preset_1')

nodz.createAttribute(node=nodeE, name='In', index=-1, preset='attr_preset_3',
                     plug=False, socket=True, dataType=int)
